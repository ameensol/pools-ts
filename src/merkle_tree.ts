...
export class MerkleTree {
    ...
    constructor({
        ...
        if (zero) {
            try {
                ...
                throw new Error(
                    `Invalid zero input, expected BigNumberish value.`
                );
            }
        } else {
        ...
        try {
            ...
            throw new Error(
                `Invalid leaves input, expected BigNumberish values.`
            );
        }
    ...
    public insert(leaf: BigNumberish): number {
        ...
        try {
            ...
            throw new Error(
                `Invalid insert leaf, expected BigNumberish value.`
            );
        }
    ...
    public update(index: number, leaf: BigNumberish) {
        ...
        try {
            ...
            throw new Error(
                `Invalid update leaf, expected BigNumberish value.`
            );
        }
        ...
        return {
            ...
            layers: this._layers.map((layer) => {
                return layer.map((value) =>
                    hexZeroPad(value.toHexString(), 32)
                );
            })
        };
    }
    ...
    static fromJSON({ layers, zero }: MerkleTreeJSON): MerkleTree {
        ...
        try {
            ...
            throw new Error(
                `Invalid layers input, expected BigNumberish values.`
            );
        }
